...
public class FSVenuesRequest extends Request {
    private Foursquare foursquare;
    private Location location;
    
    private static final int NUM_RETRIES = 3;
    
    public FSVenuesRequest(Location location, Foursquare foursquare,
    ...
    public RequestResult<List<Venue>> execute() {
        return foursquare.getVenuesNear(location);
    }
    ...
    public void addToQueue(Deque<Request> requestQueue) {
        synchronized (requestQueue) {
            ...
            while (itr.hasNext()) {
                ...
                if (request instanceof FSVenuesRequest) {
                    ((FSVenuesRequest) request).updateLocation(location);
                    return;
                }
            }
